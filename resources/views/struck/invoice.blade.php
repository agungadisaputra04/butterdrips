...
<body>
    <div class="container">
        ...
        <div class="flex-container" style="margin-bottom: 10px; text-align:right;">
            ...
            <div> {{ $invoice->jumlah }}</div>
            <div> {{ $invoice->tipes_id }}</div>
        </div>
        ...
        <div class="flex-container" style="text-align: right; margin-top: 10px;">
            ...
            <div>
                <ul>
                    <li>Jumlah Bayar/Dp</li>
                    <li>Total Biaya</li>
                    <li>Biaya Pelunasan</li>
                </ul>
            </div>
            <div style="text-align: right;">
                <ul>
                    <li>Rp {{ number_format($invoice->uang_dp,0) }} </li>
                    <li>Rp {{ number_format($invoice->total,0) }}</li>
                    <li>Rp {{ number_format($invoice->kurang,0) }}</li>
                </ul>
            </div>
        </div>
        <hr>
